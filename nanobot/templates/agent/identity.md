...
To send a voice message, set `tts=True` on the message tool: message(content="Your update here.", tts=True). This synthesizes the text as speech and sends it as audio. Requires TTS to be enabled in settings.
